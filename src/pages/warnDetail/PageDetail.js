      ...
      <div className={styles.yjData}>
        ...
        {pageType !== 4 && repeat && repeat.length > 0 && (
          <span className={styles.openData} onClick={showRepeat}>
            ...
            {repeatResult.rawType === 8 ? '部级重复预警' : '互联网重复预警'}
          </span>
        )}
            ...
            {axiosType === 'net' ? (
                  ...
                  <span className={styles.tValue}>
                    ...
                    {website && !blackListExist && (
                      <span
                        ...
                        onClick={addToBlack(website, 'WEBSITE')}
                      >
                        加入黑名单
                      </span>
                    )}
              ...
              <>
                ...
                <div>
                  ...
                  <span className={styles.tValue}>
                    {latestTime ? moment(latestTime).format(dateFormat) : '--'}
                  </span>
                  <span className={styles.tName}>通话时长(秒)</span>
                  <span className={styles.tValue}>{callDuration || '--'}</span>
                </div>
              </>
            )}
            <div>
            ...
            <div>
              ...
              <span className={styles.tValue}>
                ...
                {suspect && suspect.phone && (
                  <span
                    className={styles.rydangan}
                    onClick={addToBlack(suspect && suspect.phone, 'PHONE')}
                  >
          ...
          <div className={styles.dataC} style={{ height: 100 }}>
            ...
            >
              ...
              <div>
                ...
                <span className={styles.tValue}>{lawcase ? '诈骗' : '--'}</span>
